...
namespace Spartacus.UnitTests
{
    ...
    public class QuadraticTermsTests
    {
        ...
        public void Calculate_MoreVariables_ReturnCorrectResult()
        {
            ...
            Assert.Equal(1,
                examples[0].Variables.Count(c => c.Schema.VariableType == VariableType.Quadratic && c.Value == 4));
            Assert.Equal(1,
                examples[0].Variables.Count(c => c.Schema.VariableType == VariableType.Quadratic && c.Value == 6));
            Assert.Equal(1,
                examples[0].Variables.Count(c => c.Schema.VariableType == VariableType.Quadratic && c.Value == 9));

            Assert.Equal(1,
                examples[0].Variables.Count(c =>
                    c.Schema.VariableType == VariableType.Quadratic && c.Schema.Symbol.Equals("X*X")));
            Assert.Equal(1,
                examples[0].Variables.Count(c =>
                    c.Schema.VariableType == VariableType.Quadratic && c.Schema.Symbol.Equals("X*Y")));
            Assert.Equal(1,
                examples[0].Variables.Count(c =>
                    c.Schema.VariableType == VariableType.Quadratic && c.Schema.Symbol.Equals("Y*Y")));
        }
        ...
        public void Calculate_OneVariable_ReturenCorrectResult()
        {
            ...
            Assert.Equal("X*X",
                examples[0].Variables.Single(c => c.Schema.VariableType == VariableType.Quadratic).Schema.Symbol);
        }
    }
}